...
class ViewOptionsFmri {
            ...
            if (this.viewToggleId) {
                ...
                this.viewToggle.on('click', async () => {
                    ...
                    if (this.toggleState['viewToggle'] == 'montage') {
                        this.viewToggle.text('正交');
                    } else {
                        this.viewToggle.text('蒙太奇');
                    }
    ...
    async setStateVariables() {
        ...
        if (this.fmriFileType == 'nifti' && this.viewToggleId) {
            const viewToggle = $(`#${this.viewToggleId}`);
            viewToggle.text(this.toggleState['viewToggle'] === 'montage' ? '正交' : '蒙太奇');
        }
    }
}
